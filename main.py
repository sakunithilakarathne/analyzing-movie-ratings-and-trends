...
def main():
    try:
        ...
        box_mojo_movies = pd.read_csv("data/raw/box_mojo_data.csv")
        imdb_movies = pd.read_csv("data/raw/imdb_data.csv")
        # Combining box office mojo and IMDb data
        all_movie_data = concat_dataframes(box_mojo_movies,imdb_movies)
